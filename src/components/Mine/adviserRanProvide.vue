<template>
  <div class="adviserRanProvide">
     
        
         <div v-if="!noFetch"  v-show="!isloading">
          <div class="adviserRanProvideContainer">
          ...
          <div class=""  v-show="!seletedFlag">
             ...
             <ul class="integralCenter"  v-infinite-scroll="loadMore" 
              ...
              infinite-scroll-immediate-check="false" v-if="!noData">
                ...
                <li class="listItem" v-for="(item,i) of adviserRanadviserRanProvideList" :key="i" @click="toDetail(item.member_id)">
          ...
          <div class="noNull" v-else>
           ...
           <ul class="integralCenter"  v-infinite-scroll="TwoloadMore" 
              ...
              infinite-scroll-immediate-check="false" v-if="!noTwoData">
                ...
                <li class="listItem" v-for="(item,i) of TwoadviserRanProvideList" :key="i" @click="toDetail(item.member_id)">
                     <img class="avatars" :src="item.member_avatar" :onerror="defaultImg"/>
                    <div class="centerTitle">
                       <p class="names">{{item.member_name}}</p>  
                       <p class="phones">{{item.member_mobile.slice(0,5)+'***'+item.member_mobile.slice(8,11)}}</p>  
  ...
  data () {
    return {
     selected:"1",
      ...
      noFetch:false,
      noTwoData:false,
      adviserRanadviserRanProvideList: [], //推荐的用户
      TwoadviserRanProvideList:[],
       //初始化无限加载相关参数
      queryLoading: false,
      moreLoading: false,
      allLoaded: false,
            ...
            axios({
              ...
              if(response!=undefined){
               ...
               if(that.isCount==0){
                 ...
                 that.adviserRanProvideList=results;
                 that.isMore=false;
                 that.haveMore = false;   
                  ...
                  that.noData=true;
                   ...
                   that.adviserRanProvideList=that.adviserRanProvideList.concat(results);
        ...
        var that=this;
            axios({
              ...
              if(response!=undefined){
               ...
               if(that.TwoCount==0){
                 if(results.length!=0 && results.length<10){
                 that.TwoadviserRanProvideList=results;
                 ...
                 that.haveTwoMore = false;   
                  ...
                  that.noTwoData=true;
                   ...
                   that.TwoadviserRanProvideList=that.TwoadviserRanProvideList.concat(results);
