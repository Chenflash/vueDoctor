<template>
  <div class="provideoOtherDoctor">
     
        
         <div v-if="!noFetch"  v-show="!isloading">
          <div class="provideoOtherDoctorContainer">
    ...
    fetchadviserList(){
       var domain = process.env.NODE_ENV == 'development' ? '/api' : 'http://' + window.location.host;
        var that=this;
            axios({
                    method: 'Post',
                    url:domain+'/mobile/index.php?act=member_index&op=myCrossSectionMember',
                    data:{
