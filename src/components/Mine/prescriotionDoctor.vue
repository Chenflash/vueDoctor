<template>
  <div class="prescriotionDoctor">
        <!--有网络状态-->
        <div v-if="!noFetch"  v-show="!isloading">
           <div class="prescriotionDoctorContainer">
         ...
         <ul class="listCenter"   v-infinite-scroll="loadMore" 
              ...
              infinite-scroll-immediate-check="false" v-if="!noData">
               ...
               <li class="listItem" v-for="(item,i) of prescriotionDoctors" :key="i"   @click="toPrescription(item.order_id,item.order_state)">
                   <div class="topItem">
            ...
            axios({
              ...
              that.$store.commit("decrement");
               ...
               if(that.isCount==0){
                 ...
                 that.prescriotionDoctors=results;
                 that.isMore=false;
                 that.haveMore = false;   
                  ...
                  that.noData=true;
                   ...
                   that.prescriotionDoctors=that.prescriotionDoctors.concat(results);
